        ...
        <section className="py-12 md:py-20 bg-gray-50">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-xl text-gray-500">Stories, tips, and guides to inspire your next stay</p>
            </div>

            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="relative h-[400px] rounded-lg overflow-hidden">
                <img src="/placeholder.svg" alt="Featured post" className="w-full h-full object-cover" />
              </div>
            ...
            <div className="flex items-center justify-center gap-2 mb-12">
              <button className="rounded-full border border-gray-300 px-4 py-2 hover:bg-gray-100">All</button>
              <button className="rounded-full border border-gray-300 px-4 py-2 hover:bg-gray-100">Travel</button>
              <button className="rounded-full border border-gray-300 px-4 py-2 hover:bg-gray-100">Hosting</button>
              <button className="rounded-full border border-gray-300 px-4 py-2 hover:bg-gray-100">News</button>
              <button className="rounded-full border border-gray-300 px-4 py-2 hover:bg-gray-100">Tips</button>
            </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            ...
            <div className="max-w-md mx-auto flex gap-2">
              ...
              />
              <button className="bg-black text-white rounded-md px-4 py-2 hover:bg-gray-800">Subscribe</button>
            </div>
          </div>
        </section>
      </main>
